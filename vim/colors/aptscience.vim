" Vim color file
" aptscience.vim
" Creator/Maintainer: Marco Antonio Gomez < marcogomez(at)aptscience.org >
" Last Modified: 2010/08/10 23:01
" Version: 0.3
"
...
hi Number           ctermfg=111                                     cterm=none
" true, false
hi Boolean          guifg=#8cd0d3                                   gui=none
hi Boolean          ctermfg=111                                     cterm=none
" float
hi Float            guifg=#8cd0d3                                   gui=none
hi Float            ctermfg=111                                     cterm=none
...
hi PreProc          ctermfg=179                                     cterm=none
" #include
hi Include          guifg=#e9dfaf                                   gui=none
hi Include          ctermfg=179                                     cterm=none
" #define
hi Define           guifg=#e9dfaf                                   gui=none
hi Define           ctermfg=179                                     cterm=none
" same as define
hi Macro            guifg=#e9dfaf                                   gui=none
hi Macro            ctermfg=179                                     cterm=none
" #if, #else, #endif
hi PreCondit        guifg=#e9dfaf                                   gui=none
hi PreCondit        ctermfg=179                                     cterm=none
...
hi Todo             ctermfg=226             ctermbg=NONE            cterm=underline
...
hi CursorIM         ctermfg=bg              ctermbg=111
" cursor column
...
hi TabLineFill      ctermfg=179             ctermbg=236             cterm=none
